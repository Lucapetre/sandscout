...
allow(file-issue-extension, [extension("com.apple.sandbox.container"),regex("^/private/var/mobile/Containers/Data/[^/]+/[-0-9A-Z]+/StoreKit/"/i)]).
allow(file-issue-extension, [extension("com.apple.sandbox.container"),regex("^/private/var/mobile/Containers/Data/[^/]+/[-0-9A-Z]+/StoreKit$"/i)]).
allow(file-issue-extension, [extension("com.apple.sandbox.container"),regex("^/private/var/mobile/Containers/Data/[^/]+/[-0-9A-Z]+/iTunesArtwork$"/i)]).
...
allow(file-issue-extension, [subpath("/private/var/mobile/Library/Mobile Documents/"),require-entitlement("com.apple.private.librarian.container-proxy",[])]).
...
allow(file-readSTAR, [literal("/private/var/mobile/Library/Preferences/com.apple.mobilephone.speeddial.plist"),extension("com.apple.tcc.kTCCServiceAddressBook")]).
allow(file-readSTAR, [subpath("/private/var/mobile/Library/AddressBook/"),extension("com.apple.tcc.kTCCServiceAddressBook")]).
allow(file-readSTAR, [literal("/private/var/mobile/Media/PhotoData/syncInfo.plist"),extension("com.apple.tcc.kTCCServicePhotos")]).
allow(file-readSTAR, [subpath("/private/var/mobile/Media/PhotoData/Thumbnails/"),extension("com.apple.tcc.kTCCServicePhotos")]).
allow(file-readSTAR, [subpath("/private/var/mobile/Media/PhotoData/Sync/FaceAlbumThumbnails/"),extension("com.apple.tcc.kTCCServicePhotos")]).
allow(file-readSTAR, [subpath("/private/var/mobile/Media/PhotoData/Metadata/"),extension("com.apple.tcc.kTCCServicePhotos")]).
allow(file-readSTAR, [regex("^/private/var/mobile/Media/PhotoData/Photos[.]sqlite$"/i),extension("com.apple.tcc.kTCCServicePhotos")]).
allow(file-readSTAR, [regex("^/private/var/mobile/Media/PhotoData/Photos[.]sqlite-wal$"/i),extension("com.apple.tcc.kTCCServicePhotos")]).
allow(file-readSTAR, [regex("^/private/var/mobile/Media/PhotoData/Photos[.]sqlite-shm$"/i),extension("com.apple.tcc.kTCCServicePhotos")]).
allow(file-readSTAR, [regex("^/private/var/mobile/Media/PhotoData/Photos[.]sqlite-journal$"/i),extension("com.apple.tcc.kTCCServicePhotos")]).
...
allow(file-readSTAR, [literal("/private/var/mobile/Library/CoreDuet/People/interactionC.db-wal"),require-entitlement("com.apple.coreduetd.people",[])]).
allow(file-readSTAR, [literal("/private/var/mobile/Library/CoreDuet/People/interactionC.db-shm"),require-entitlement("com.apple.coreduetd.people",[])]).
allow(file-readSTAR, [literal("/private/var/mobile/Library/CoreDuet/People/interactionC.db"),require-entitlement("com.apple.coreduetd.people",[])]).
allow(file-readSTAR, [literal("/private/var/mobile/Library/CoreDuet/People"),require-entitlement("com.apple.coreduetd.people",[])]).
...
allow(file-readSTAR, [require-not(literal("/private/var/mobile/Library/Preferences/com.apple.apsalerts.plist")),extension("com.apple.sandbox.application-group"),require-not(regex("^/private/var/mobile/Containers/Shared/AppGroup/[-0-9A-Z]+/[.]com[.]apple[.]"/i))]).
...
allow(file-readSTAR, [require-not(literal("/private/var/mobile/Library/Preferences/com.apple.apsalerts.plist")),require-not(literal("/private/var/mobile/Library/Caches/GeoServices/tguid.bin")),require-not(subpath("/private/var/mobile/Library/FairPlay/")),require-not(literal("/usr/sbin/fairplayd")),require-not(subpath("/private/var/mobile/Media/")),vnode-type(block-device),vnode-type(character-device),literal("/private/etc/protocols")]).
allow(file-readSTAR, [require-not(literal("/private/var/mobile/Library/Preferences/com.apple.apsalerts.plist")),require-not(literal("/private/var/mobile/Library/Caches/GeoServices/tguid.bin")),require-not(subpath("/private/var/mobile/Library/FairPlay/")),require-not(literal("/usr/sbin/fairplayd")),require-not(subpath("/private/var/mobile/Media/")),vnode-type(block-device),vnode-type(character-device),literal("/private/etc/services")]).
allow(file-readSTAR, [require-not(literal("/private/var/mobile/Library/Preferences/com.apple.apsalerts.plist")),require-not(literal("/private/var/mobile/Library/Caches/GeoServices/tguid.bin")),require-not(subpath("/private/var/mobile/Library/FairPlay/")),require-not(literal("/usr/sbin/fairplayd")),require-not(subpath("/private/var/mobile/Media/")),vnode-type(block-device),vnode-type(character-device),literal("/")]).
allow(file-readSTAR, [require-not(literal("/private/var/mobile/Library/Preferences/com.apple.apsalerts.plist")),require-not(literal("/private/var/mobile/Library/Caches/GeoServices/tguid.bin")),require-not(subpath("/private/var/mobile/Library/FairPlay/")),require-not(literal("/usr/sbin/fairplayd")),require-not(subpath("/private/var/mobile/Media/")),vnode-type(block-device),vnode-type(character-device),literal("/private/var/mobile/Library/CoreDuet/People/interactionC.db-journal"),require-entitlement("com.apple.coreduetd.people",[])]).
allow(file-readSTAR, [require-not(literal("/private/var/mobile/Library/Preferences/com.apple.apsalerts.plist")),require-not(literal("/private/var/mobile/Library/Caches/GeoServices/tguid.bin")),require-not(subpath("/private/var/mobile/Library/FairPlay/")),require-not(literal("/usr/sbin/fairplayd")),require-not(subpath("/private/var/mobile/Media/")),vnode-type(block-device),vnode-type(character-device),literal("/private/etc/hosts")]).
allow(file-readSTAR, [require-not(literal("/private/var/mobile/Library/Preferences/com.apple.apsalerts.plist")),require-not(literal("/private/var/mobile/Library/Caches/GeoServices/tguid.bin")),require-not(subpath("/private/var/mobile/Library/FairPlay/")),require-not(literal("/usr/sbin/fairplayd")),require-not(subpath("/private/var/mobile/Media/")),vnode-type(block-device),vnode-type(character-device),literal("/private/etc/group")]).
allow(file-readSTAR, [require-not(literal("/private/var/mobile/Library/Preferences/com.apple.apsalerts.plist")),require-not(literal("/private/var/mobile/Library/Caches/GeoServices/tguid.bin")),require-not(subpath("/private/var/mobile/Library/FairPlay/")),require-not(literal("/usr/sbin/fairplayd")),require-not(subpath("/private/var/mobile/Media/")),vnode-type(block-device),vnode-type(character-device),literal("/private/etc/passwd")]).
allow(file-readSTAR, [require-not(literal("/private/var/mobile/Library/Preferences/com.apple.apsalerts.plist")),require-not(literal("/private/var/mobile/Library/Caches/GeoServices/tguid.bin")),require-not(subpath("/private/var/mobile/Library/FairPlay/")),require-not(literal("/usr/sbin/fairplayd")),require-not(subpath("/private/var/mobile/Media/")),vnode-type(block-device),vnode-type(character-device),literal("/private/var/mobile/Library/CoreDuet/People/interactionC.db-wal")]).
allow(file-readSTAR, [require-not(literal("/private/var/mobile/Library/Preferences/com.apple.apsalerts.plist")),require-not(literal("/private/var/mobile/Library/Caches/GeoServices/tguid.bin")),require-not(subpath("/private/var/mobile/Library/FairPlay/")),require-not(literal("/usr/sbin/fairplayd")),require-not(subpath("/private/var/mobile/Media/")),vnode-type(block-device),vnode-type(character-device),literal("/private/var/mobile/Library/CoreDuet/People/interactionC.db-shm")]).
...
allow(file-readSTAR, [require-not(literal("/private/var/mobile/Library/Preferences/com.apple.apsalerts.plist")),require-not(literal("/private/var/mobile/Library/Caches/GeoServices/tguid.bin")),literal("/private/var/mobile/Media/PhotoData/syncInfo.plist")]).
allow(file-readSTAR, [require-not(literal("/private/var/mobile/Library/Preferences/com.apple.apsalerts.plist")),require-not(literal("/private/var/mobile/Library/Caches/GeoServices/tguid.bin")),subpath("/private/var/mobile/Media/PhotoData/Thumbnails/")]).
allow(file-readSTAR, [require-not(literal("/private/var/mobile/Library/Preferences/com.apple.apsalerts.plist")),require-not(literal("/private/var/mobile/Library/Caches/GeoServices/tguid.bin")),subpath("/private/var/mobile/Media/PhotoData/Sync/FaceAlbumThumbnails/")]).
allow(file-readSTAR, [require-not(literal("/private/var/mobile/Library/Preferences/com.apple.apsalerts.plist")),require-not(literal("/private/var/mobile/Library/Caches/GeoServices/tguid.bin")),subpath("/private/var/mobile/Media/PhotoData/Metadata/")]).
allow(file-readSTAR, [require-not(literal("/private/var/mobile/Library/Preferences/com.apple.apsalerts.plist")),require-not(literal("/private/var/mobile/Library/Caches/GeoServices/tguid.bin")),regex("^/private/var/mobile/Media/PhotoData/Photos[.]sqlite$"/i)]).
allow(file-readSTAR, [require-not(literal("/private/var/mobile/Library/Preferences/com.apple.apsalerts.plist")),require-not(literal("/private/var/mobile/Library/Caches/GeoServices/tguid.bin")),regex("^/private/var/mobile/Media/PhotoData/Photos[.]sqlite-wal$"/i)]).
allow(file-readSTAR, [require-not(literal("/private/var/mobile/Library/Preferences/com.apple.apsalerts.plist")),require-not(literal("/private/var/mobile/Library/Caches/GeoServices/tguid.bin")),regex("^/private/var/mobile/Media/PhotoData/Photos[.]sqlite-shm$"/i)]).
allow(file-readSTAR, [require-not(literal("/private/var/mobile/Library/Preferences/com.apple.apsalerts.plist")),require-not(literal("/private/var/mobile/Library/Caches/GeoServices/tguid.bin")),regex("^/private/var/mobile/Media/PhotoData/Photos[.]sqlite-journal$"/i)]).
allow(file-readSTAR, [require-not(literal("/private/var/mobile/Library/Preferences/com.apple.apsalerts.plist")),literal("/private/var/mobile/Library/Preferences/com.apple.mobilephone.speeddial.plist")]).
allow(file-readSTAR, [require-not(literal("/private/var/mobile/Library/Preferences/com.apple.apsalerts.plist")),subpath("/private/var/mobile/Library/AddressBook/")]).
...
allow(file-readSTAR, [subpath("/System/Library/Carrier Bundles/"),require-entitlement("com.apple.private.signing-identifier",[entitlement-value("com.apple.mobilemail")])]).
allow(file-readSTAR, [subpath("/System/Library/Carrier Bundles/"),require-entitlement("com.apple.security.exception.carrier-bundle.read",[])]).
...
allow(file-readSTAR, [subpath("/Developer/"),require-not(entitlement-value(#t))]).
allow(file-readSTAR, [subpath("/Developer/"),require-entitlement("com.apple.private.security.sandbox.debug-mode",[])]).
allow(file-readSTAR, [subpath("/Developer/"),require-entitlement("platform-application",[])]).
...
allow(file-read-metadata, [require-entitlement("com.apple.private.signing-identifier",[entitlement-value("com.apple.mobilesafari")])]).
allow(file-read-metadata, [require-entitlement("com.apple.private.signing-identifier",[entitlement-value("com.apple.iBooks")])]).
allow(file-read-metadata, [require-entitlement("com.apple.private.signing-identifier",[entitlement-value("com.apple.itunesu")])]).
allow(file-read-metadata, [require-entitlement("com.apple.container2",[])]).
allow(file-read-metadata, [literal("/private/var/mobile/Library/com.apple.iTunesStore")]).
allow(file-read-metadata, [literal("/private/var/mobile/Library/com.apple.iTunesStore/LocalStorage")]).
...
allow(file-write-create, [require-entitlement("com.apple.private.signing-identifier",[entitlement-value("com.apple.mobilesafari")])]).
allow(file-write-create, [require-entitlement("com.apple.private.signing-identifier",[entitlement-value("com.apple.iBooks")])]).
allow(file-write-create, [require-entitlement("com.apple.private.signing-identifier",[entitlement-value("com.apple.itunesu")])]).
allow(file-write-create, [require-entitlement("com.apple.container2",[])]).
allow(file-write-create, [literal("/private/var/mobile/Library/com.apple.iTunesStore")]).
allow(file-write-create, [literal("/private/var/mobile/Library/com.apple.iTunesStore/LocalStorage")]).
allow(file-write-create, [literal("/private/var/mobile/Library/Preferences/com.apple.dataaccess.launchd"),require-entitlement("com.apple.private.signing-identifier",[entitlement-value("com.apple.mobilemail")])]).
allow(file-write-create, [literal("/private/var/mobile/Library/Preferences/com.apple.AOSNotification.launchd"),require-entitlement("com.apple.private.signing-identifier",[entitlement-value("com.apple.mobilemail")])]).
...
allow(file-write-create, [require-not(regex("^/private/var/mobile/Library/Logs/CrashReporter/CFNetwork_"/i)),vnode-type(directory)]).
allow(file-write-create, [require-not(regex("^/private/var/mobile/Library/Logs/CrashReporter/CFNetwork_"/i)),literal("/private/var/mobile/Library/Caches/sharedCaches/com.apple.iTunesStore.NSURLCache"),require-entitlement("com.apple.private.signing-identifier",[require-not(entitlement-value("com.apple.iBooks")),require-not(entitlement-value("com.apple.itunesu"))])]).
allow(file-write-create, [require-not(regex("^/private/var/mobile/Library/Logs/CrashReporter/CFNetwork_"/i)),literal("/private/var/mobile/Library/Caches/sharedCaches/com.apple.iTunesStore.NSURLCache"),require-entitlement("com.apple.container2",[])]).
allow(file-write-create, [require-not(regex("^/private/var/mobile/Library/Logs/CrashReporter/CFNetwork_"/i)),vnode-type(directory)]).
...
allow(file-write-create, [require-not(regex("^/private/var/mobile/Library/Logs/CrashReporter/CFNetwork_"/i)),extension("com.apple.sandbox.application-group"),require-not(regex("^/private/var/mobile/Containers/Shared/AppGroup/[-0-9A-Z]+/Library$"/i)),require-not(regex("^/private/var/mobile/Containers/Shared/AppGroup/[-0-9A-Z]+/Library/Preferences$"/i))]).
...
allow(file-write-create, [require-not(regex("^/private/var/mobile/Library/Logs/CrashReporter/CFNetwork_"/i)),literal("/private/var/mobile/Library/Preferences/com.apple.dataaccess.launchd")]).
allow(file-write-create, [require-not(regex("^/private/var/mobile/Library/Logs/CrashReporter/CFNetwork_"/i)),literal("/private/var/mobile/Library/Preferences/com.apple.AOSNotification.launchd")]).
allow(file-write-create, [require-not(regex("^/private/var/mobile/Library/Logs/CrashReporter/CFNetwork_"/i)),literal("/private/var/mobile/Library/Caches/sharedCaches/com.apple.Radio.RadioRequestURLCache")]).
allow(file-write-create, [require-not(regex("^/private/var/mobile/Library/Logs/CrashReporter/CFNetwork_"/i)),literal("/private/var/mobile/Library/Caches/sharedCaches/com.apple.Radio.RadioImageCache")]).
...
allow(iokit-get-properties, [iokit-connection-regex("^BackCamera"/i)]).
allow(iokit-get-properties, [require-not(iokit-connection-regex("-mac-address"/i)),require-not(iokit-connection-regex("mac-address-"/i)),require-not(iokit-connection-regex(".+-mac-address"/i)),require-not(iokit-connection-regex(".+mac-address-"/i))]).
...
allow(ipc-posix-shmSTAR, [ipc-posix-name-regex("^OA-"/i),require-not(entitlement-value(#t))]).
allow(ipc-posix-shmSTAR, [ipc-posix-name-regex("^stack-logs"/i),require-not(entitlement-value(#t))]).
allow(ipc-posix-shmSTAR, [ipc-posix-name-regex("^/FSM-"/i),require-not(entitlement-value(#t))]).
...
allow(ipc-posix-shmSTAR, [ipc-posix-name-regex("^OA-"/i),require-entitlement("platform-application",[])]).
allow(ipc-posix-shmSTAR, [ipc-posix-name-regex("^stack-logs"/i),require-entitlement("platform-application",[])]).
allow(ipc-posix-shmSTAR, [ipc-posix-name-regex("^/FSM-"/i),require-entitlement("platform-application",[])]).
...
allow(ipc-posix-shm-readSTAR, [ipc-posix-name-regex("^gdt-[0-9A-Za-z]+-c$"/i),require-not(entitlement-value(#t))]).
allow(ipc-posix-shm-readSTAR, [ipc-posix-name-regex("^gdt-[0-9A-Za-z]+-s$"/i),require-not(entitlement-value(#t))]).
...
allow(ipc-posix-shm-readSTAR, [ipc-posix-name-regex("^gdt-[0-9A-Za-z]+-c$"/i),require-entitlement("platform-application",[])]).
allow(ipc-posix-shm-readSTAR, [ipc-posix-name-regex("^gdt-[0-9A-Za-z]+-s$"/i),require-entitlement("platform-application",[])]).
...
allow(ipc-posix-shm-write-data, [ipc-posix-name-regex("^gdt-[0-9A-Za-z]+-c$"/i),require-not(entitlement-value(#t))]).
allow(ipc-posix-shm-write-data, [ipc-posix-name-regex("^gdt-[0-9A-Za-z]+-s$"/i),require-not(entitlement-value(#t))]).
...
allow(ipc-posix-shm-write-data, [ipc-posix-name-regex("^gdt-[0-9A-Za-z]+-c$"/i),require-entitlement("platform-application",[])]).
allow(ipc-posix-shm-write-data, [ipc-posix-name-regex("^gdt-[0-9A-Za-z]+-s$"/i),require-entitlement("platform-application",[])]).
...
allow(ipc-posix-shm-write-unlink, [ipc-posix-name-regex("^gdt-[0-9A-Za-z]+-c$"/i),require-not(entitlement-value(#t))]).
allow(ipc-posix-shm-write-unlink, [ipc-posix-name-regex("^gdt-[0-9A-Za-z]+-s$"/i),require-not(entitlement-value(#t))]).
...
allow(ipc-posix-shm-write-unlink, [ipc-posix-name-regex("^gdt-[0-9A-Za-z]+-c$"/i),require-entitlement("platform-application",[])]).
allow(ipc-posix-shm-write-unlink, [ipc-posix-name-regex("^gdt-[0-9A-Za-z]+-s$"/i),require-entitlement("platform-application",[])]).
...
allow(mach-register, [global-name("com.apple.Music.MPMusicPlayerMigServerExists"),require-entitlement("com.apple.private.signing-identifier",[entitlement-value("com.apple.Music")])]).
allow(mach-register, [global-name("com.apple.Music.MPMusicPlayerControllerInternal"),require-entitlement("com.apple.private.signing-identifier",[entitlement-value("com.apple.Music")])]).
...
allow(network-outbound, [extension("com.apple.sandbox.container"),regex("^/private/var/mobile/Containers/Data/[^/]+/[-0-9A-Z]+/tmp/"/i)]).
allow(network-outbound, [extension("com.apple.sandbox.container"),regex("^/private/var/mobile/Containers/Data/[^/]+/[-0-9A-Z]+/tmp$"/i)]).
allow(network-outbound, [extension("com.apple.sandbox.container"),regex("^/private/var/mobile/Containers/Data/[^/]+/[-0-9A-Z]+/Library/"/i)]).
allow(network-outbound, [extension("com.apple.sandbox.container"),regex("^/private/var/mobile/Containers/Data/[^/]+/[-0-9A-Z]+/Library$"/i)]).
allow(network-outbound, [extension("com.apple.sandbox.container"),regex("^/private/var/mobile/Containers/Data/[^/]+/[-0-9A-Z]+/Documents/"/i)]).
allow(network-outbound, [extension("com.apple.sandbox.container"),regex("^/private/var/mobile/Containers/Data/[^/]+/[-0-9A-Z]+/Documents$"/i)]).
allow(network-outbound, [literal("/private/var/run/lockdown.sock"),require-entitlement("platform-application",[])]).
allow(network-outbound, [require-not(remote(tcp("localhost:22"))),require-not(remote(tcp("localhost:23"))),require-not(remote(tcp("localhost:873"))),require-not(remote(tcp("localhost:62078"))),literal("/private/var/run/printd")]).
allow(network-outbound, [require-not(remote(tcp("localhost:22"))),require-not(remote(tcp("localhost:23"))),require-not(remote(tcp("localhost:873"))),require-not(remote(tcp("localhost:62078"))),regex("^/private/var/ea/ea[.0-9]+$"/i)]).
allow(network-outbound, [require-not(remote(tcp("localhost:22"))),require-not(remote(tcp("localhost:23"))),require-not(remote(tcp("localhost:873"))),require-not(remote(tcp("localhost:62078"))),literal("/private/var/run/syslog")]).
allow(network-outbound, [require-not(remote(tcp("localhost:22"))),require-not(remote(tcp("localhost:23"))),require-not(remote(tcp("localhost:873"))),require-not(remote(tcp("localhost:62078"))),literal("/private/var/run/mDNSResponder")]).
allow(network-outbound, [require-not(remote(tcp("localhost:22"))),require-not(remote(tcp("localhost:23"))),require-not(remote(tcp("localhost:873"))),require-not(remote(tcp("localhost:62078"))),control-name("com.apple.network.statistics")]).
allow(network-outbound, [require-not(remote(tcp("localhost:22"))),require-not(remote(tcp("localhost:23"))),require-not(remote(tcp("localhost:873"))),require-not(remote(tcp("localhost:62078"))),control-name("com.apple.netsrc")]).
allow(network-outbound, [require-not(remote(tcp("localhost:22"))),require-not(remote(tcp("localhost:23"))),require-not(remote(tcp("localhost:873"))),require-not(remote(tcp("localhost:62078"))),remote(ip("*:*"))]).
allow(network-outbound, [require-not(remote(tcp("localhost:22"))),require-not(remote(tcp("localhost:23"))),require-not(remote(tcp("localhost:873"))),require-not(remote(tcp("localhost:62078"))),extension("com.apple.sandbox.application-group"),regex("^/private/var/mobile/Containers/Shared/AppGroup/[-0-9A-Z]+/"/i)]).
allow(nvramSTAR, []).
allow(nvram-delete, []).
allow(nvram-get, []).
allow(nvram-set, []).
